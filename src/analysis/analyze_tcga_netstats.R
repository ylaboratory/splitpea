...
# to be run after running analysis/get_largestcc_sizes.py and
# get_consensus_network_stats.py
...
largest_ccs = fread("/IRIS/tcga_splitpea_network.largest_ccs.txt")
...
consensus_stats_all = fread("IRIS/consensus_threshold.sizes.txt")
