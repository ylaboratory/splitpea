...
out = open(base_dir + "/examples/consensus_threshold.lcc_sizes.txt", 'w')
...
for c in cancers:
    ...
    c_consensus_neg = pickle.load(open(base_dir + "/examples/" + c + "_consensus_neg.pickle", 'rb'))
    c_consensus_pos = pickle.load(open(base_dir + "/examples/" + c + "_consensus_pos.pickle", 'rb'))
    ...
    for t in thresholds:
        ...
        with open(base_dir + "/examples/" + c + "_consensus_neg.thres_" + str(t) + ".pickle", 'wb') as out:
            print(thres_neg)
            pickle.dump(thres_neg, out)
        
        with open(base_dir + "/examples/" + c + "_consensus_pos.thres_" + str(t) + ".pickle", 'wb') as out:
            print(thres_pos)
            pickle.dump(thres_pos, out)

        with open(base_dir + "/examples/" + c + "_consensus_joint.thres_" + str(t) + ".pickle", 'wb') as out:
